 ...
 * @author tla
 */
public class TEIParallelSegInputTest extends TestCase {
    ...
    public void testTEIPSInput() throws Exception {
        ...
        try {
            String fileName = "src/TestFiles/florilegium_tei_ps.xml";
            cResult = Util.createTraditionFromFile(jerseyTest, "Florilegium", "LR", "1", fileName, "tei");
