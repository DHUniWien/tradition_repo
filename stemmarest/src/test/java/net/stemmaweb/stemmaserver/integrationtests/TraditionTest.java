...
public class TraditionTest {
	...
	public void getDotTest()
	{
		...
		String expected = "digraph { n4 [label=\"#START#\"];n4->n5[label=\"A,B,C\";id=\"e0\"];"
				+ "n5 [label=\"when\"];n5->n16[label=\"A\";id=\"e1\"];n5->n24[label=\"B,C\";id=\"e2\"];"
				+ "n16 [label=\"april\"];n16->n22[label=\"A\";id=\"e3\"];"
				+ "n24 [label=\"showers\"];n24->n25[label=\"A,B,C\";id=\"e5\"];"
				+ "n22 [label=\"with\"];n22->n23[label=\"A\";id=\"e6\"];"
				+ "n25 [label=\"sweet\"];n25->n26[label=\"A,B,C\";id=\"e7\"];"
				+ "n23 [label=\"his\"];n23->n24[label=\"A\";id=\"e8\"];"
				+ "n26 [label=\"with\"];n26->n27[label=\"B,C\";id=\"e9\"];n26->n7[label=\"A\";id=\"e10\"];"
				+ "n27 [label=\"april\"];n27->n7[label=\"B,C\";id=\"e11\"];"
				+ "n7 [label=\"fruit\"];n7->n9[label=\"C\";id=\"e12\"];n7->n8[label=\"A,B\";id=\"e13\"];"
				+ "n9 [label=\"teh\"];n9->n11[label=\"C\";id=\"e14\"];"
				+ "n8 [label=\"the\"];n8->n10[label=\"B\";id=\"e15\"];n8->n11[label=\"A\";id=\"e16\"];"
				+ "n11 [label=\"drought\"];n11->n12[label=\"A,C\";id=\"e17\"];"
				+ "n10 [label=\"march\"];n10->n12[label=\"B\";id=\"e19\"];"
				+ "n12 [label=\"of\"];n12->n14[label=\"B\";id=\"e21\"];n12->n13[label=\"A,C\";id=\"e22\"];"
				+ "n14 [label=\"drought\"];n14->n15[label=\"B\";id=\"e23\"];"
				+ "n13 [label=\"march\"];n13->n15[label=\"A,C\";id=\"e24\"];"
				+ "n15 [label=\"has\"];n15->n17[label=\"A,B,C\";id=\"e25\"];"
				+ "n17 [label=\"pierced\"];n17->n18[label=\"A\";id=\"e26\"];n17->n19[label=\"B\";id=\"e27\"];"
				+ "n17->n20[label=\"C\";id=\"e28\"];n18 [label=\"unto\"];n18->n21[label=\"A\";id=\"e29\"];"
				+ "n19 [label=\"to\"];n19->n21[label=\"B\";id=\"e30\"];n20 [label=\"teh\"];"
				+ "n20->n28[label=\"C\";id=\"e31\"];n21 [label=\"the\"];n21->n6[label=\"A,B\";id=\"e32\"];"
				+ "n28 [label=\"rood\"];n28->n3[label=\"C\";id=\"e33\"];n6 [label=\"root\"];"
				+ "n6->n3[label=\"A,B\";id=\"e34\"];n3 [label=\"#END#\"];"
				+ "subgraph { edge [dir=none]n16->n27[style=dotted;label=\"transposition\";id=\"e4\"];"
