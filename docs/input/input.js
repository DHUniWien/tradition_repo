...
com.qmino.miredot.restApiSource = {
	...
	"dateOfGeneration":"2019-06-02 23:13:54",
	"validLicense":true,
	"licenseErrorMessage":[
...
com.qmino.miredot.restApiSource.tos = {
	...
	"net_stemmaweb_model_WitnessTextModel_in":{
		"type":"complex",
		"name":"net_stemmaweb_model_WitnessTextModel_in",
		"content":[
		],
	},
	"net_stemmaweb_model_WitnessTextModel_out":{
		"type":"complex",
		"name":"net_stemmaweb_model_WitnessTextModel_out",
		"content":[
		],
	},
...
com.qmino.miredot.restApiSource.tos["net_stemmaweb_model_TraditionModel_in"].content = [
	...
	},
	{
		...
		"fullComment":"Language of the tradition",
		"typeValue":{
			"type":"simple",
			"typeValue":"string",
		},
	...
	},
	{
		...
		"fullComment":"User ID of the tradition's owner",
		"typeValue":{
			"type":"simple",
			"typeValue":"string",
		},
...
com.qmino.miredot.restApiSource.tos["net_stemmaweb_model_WitnessTextModel_in"].content = [
	{
		"name":"text",
		"comment":null,
		"fullComment":null,
...
com.qmino.miredot.restApiSource.tos["net_stemmaweb_model_WitnessTextModel_in"].ordered = false;
com.qmino.miredot.restApiSource.tos["net_stemmaweb_model_WitnessTextModel_in"].comment = null;
com.qmino.miredot.restApiSource.tos["net_stemmaweb_model_WitnessTextModel_out"].content = [
	{
		"name":"text",
		"comment":null,
		"fullComment":null,
...
com.qmino.miredot.restApiSource.tos["net_stemmaweb_model_WitnessTextModel_out"].ordered = false;
com.qmino.miredot.restApiSource.tos["net_stemmaweb_model_WitnessTextModel_out"].comment = null;
com.qmino.miredot.restApiSource.tos["net_stemmaweb_model_RelationModel_in"].content = [
	{
		...
		"fullComment":"The ID of the second reading in the relationship",
		"typeValue":{
			"type":"simple",
			"typeValue":"string",
		},
	...
	},
	{
		...
		"fullComment":"True if the source reading could be guessed by a scribe who saw the target reading in an exemplar",
		"typeValue":{
			"type":"simple",
			"typeValue":"boolean",
		},
	...
	},
	{
		...
		"fullComment":"A numeric value to designate the impact that this variation has on the meaning of the text",
		"typeValue":{
			"type":"simple",
			"typeValue":"number",
		},
	...
	},
	{
		...
		"fullComment":"True if the target reading could be guessed by a scribe who saw the source reading in an exemplar",
		"typeValue":{
			"type":"simple",
			"typeValue":"boolean",
		},
	...
	},
	{
		...
		"fullComment":"Gosh I don't remember",
		"typeValue":{
			"type":"simple",
			"typeValue":"string",
		},
	...
	},
	{
		...
		"fullComment":"True if the editor believes this variation has stemmatic / genealogical significance",
		"typeValue":{
			"type":"simple",
			"typeValue":"string",
		},
	...
	},
	{
		...
		"fullComment":"True if this variation is unlikely to have arisen in two branches of the stemma coincidentally",
		"typeValue":{
			"type":"simple",
			"typeValue":"boolean",
		},
...
com.qmino.miredot.restApiSource.tos["net_stemmaweb_model_SectionModel_in"].content = [
	{
		...
		"fullComment":"The name of the section",
		"typeValue":{
			"type":"simple",
			"typeValue":"string",
		},
	...
	},
	{
		...
		"fullComment":"The language of the section's text",
		"typeValue":{
			"type":"simple",
			"typeValue":"string",
		},
	...
	},
	{
		...
		"fullComment":"The internal ID of the section",
		"typeValue":{
			"type":"simple",
			"typeValue":"string",
		},
...
com.qmino.miredot.restApiSource.tos["net_stemmaweb_model_ReadingModel_in"].content = [
	...
	},
	{
		...
		"fullComment":"The ID of the section to which this reading belongs",
		"typeValue":{
			"type":"simple",
			"typeValue":"string",
		},
	...
	},
	{
		...
		"fullComment":"True if the reading appears in all witnesses",
		"typeValue":{
			"type":"simple",
			"typeValue":"boolean",
		},
	...
	},
	{
		...
		"fullComment":"True if the reading is a collation end node",
		"typeValue":{
			"type":"simple",
			"typeValue":"boolean",
		},
	...
	},
	{
		...
		"fullComment":"True if the reading is an emendation",
		"typeValue":{
			"type":"simple",
			"typeValue":"boolean",
		},
	...
	},
	{
		...
		"fullComment":"True if the reading is a collation start node",
		"typeValue":{
			"type":"simple",
			"typeValue":"boolean",
		},
...
com.qmino.miredot.restApiSource.tos["net_stemmaweb_model_RelationTypeModel_in"].content = [
	...
	},
	{
		...
		"fullComment":"Whether this relationship type is transitive - that is, if A is related to B and C via this type, is B also related to C via the same type?",
		"typeValue":{
			"type":"simple",
			"typeValue":"boolean",
		},
...
com.qmino.miredot.restApiSource.tos["net_stemmaweb_model_SequenceModel_in"].content = [
	...
	},
	{
		...
		"fullComment":"Any layer witnesses that travel along this sequence route",
		"typeValue":{
			"type":"map",
			"typeKey":{
				"type":"simple",
	...
	},
	{
		...
		"fullComment":"The relationship type of this sequence: SEQUENCE, LEMMA_TEXT, or EMENDED",
		"typeValue":{
			"type":"simple",
			"typeValue":"string",
		},
...
com.qmino.miredot.restApiSource.tos["net_stemmaweb_model_AnnotationModel_in"].content = [
	{
		...
		"fullComment":"A map of property keys to values",
		"typeValue":{
			"type":"map",
			"typeKey":{
				"type":"simple",
...
com.qmino.miredot.restApiSource.tos["net_stemmaweb_model_AnnotationModel_out"].content = [
	...
	},
	{
		...
		"fullComment":"The ID of the annotation",
		"typeValue":{
			"type":"simple",
			"typeValue":"string",
		},
...
com.qmino.miredot.restApiSource.tos["net_stemmaweb_rest_Tradition_out"].content = [
	{
		"name":"relation",
		"comment":"Delegates to <code>Relation</code> module",
		"fullComment":"Delegates to <code>Relation</code> module",
...
com.qmino.miredot.restApiSource.tos["net_stemmaweb_rest_Reading_in"].content = [
	{
		...
		"fullComment":"Toggles whether this reading is a lemma. If so, ensures that no other reading at this rank in this section is a lemma. Returns all readings that were changed.",
		"typeValue":{
			"type":"simple",
			"typeValue":"string",
		},
...
com.qmino.miredot.restApiSource.tos["net_stemmaweb_model_ProposedEmendationModel_in"].content = [
	{
		...
		"fullComment":"The reading that is being proposed for this point in the text",
		"typeValue":{
			"type":"simple",
			"typeValue":"string",
		},
	...
	},
	{
		...
		"fullComment":"The rank (inclusive) at which the emendation should start",
		"typeValue":{
			"type":"simple",
			"typeValue":"number",
		},
	...
	},
	{
		...
		"fullComment":"The rank (exclusive) at which the emendation should end",
		"typeValue":{
			"type":"simple",
			"typeValue":"number",
		},
...
com.qmino.miredot.restApiSource.interfaces = [
	...
	{
		"beschrijving":"Delete an outbound link from this annotation node. Type and target are specified via an <code>AnnotationLinkModel</code>. Returns the annotation with the link deleted.",
	...
	},
	{
		...
		"permitAll":false,
		"output":{
			"typeValue":com.qmino.miredot.restApiSource.tos["net_stemmaweb_model_WitnessTextModel_out"],
			"comment":"a WitnessTextModel containing the requested lemma text",
		},
		"statusCodes":[
			{
				"httpCode":200,
	...
	{
		"beschrijving":"Add an outbound link from this annotation node. Type and target are specified via an <code>AnnotationLinkModel</code>. Returns the annotation including the new link.",
		"url":"/tradition/{tradId}/annotation/{annoid}/link",
		"http":"POST",
			...
			"QUERY":[
				{
					...
					"comment":"- Whether or not to include witness information in the XML",
					"jaxrs":"QUERY",
				},
			],
			"BODY":[
